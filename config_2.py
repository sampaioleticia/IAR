...
class AntClusteringHeterogêneo:
    ...
    def simular(self, num_iteracoes: int, verbose: bool = False, intervalo_log: int = 1000000,
                iteracoes_para_plotar: List[int] = None, pasta_saida: str = '4_graficos'):
        import os
...
if __name__ == "__main__":
    ...
    tempo = clustering.simular(
        ...
        iteracoes_para_plotar=[0, 100000, 500000, 1000000, 5000000, 10000000, 20000000, 30000000, 40000000, 50000000],
