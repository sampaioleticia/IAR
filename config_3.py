...
class AntClusteringHeterogêneo:
    ...
    def simular(self, num_iteracoes: int, verbose: bool = False, intervalo_log: int = 1000000,
                iteracoes_para_plotar: List[int] = None, pasta_saida: str = '5_graficos'):
        import os
        ...
        for i in range(num_iteracoes):
            ...
            if verbose and (i + 1) % intervalo_log == 0:
                ...
                print(f"  [{i + 1:>8}/{num_iteracoes}] Tempo: {tempo_decorrido:>6.1f}s | Grid: {metricas['itens_no_grid']:>3} | Carregando: {metricas['formigas_carregando']:>2}")
...
if __name__ == "__main__":
    ARQUIVO = "base_sintetica_4_grupos.txt" 
    GRID_SIZE = 64
    NUM_AGENTES = 20  
    K1 = 0.4 
    K2 = 0.03 
    ALPHA = 0.25  
    RAIO_VISAO = 1  
    NUM_ITERACOES = 5000000 
    NORMALIZAR = True 
    TEMPERATURA_MOVIMENTO = 2.5 
    ...
    tempo = clustering.simular(
        ...
        iteracoes_para_plotar=[0, 100000, 500000, 1000000, 2000000, 3000000, 4000000, 5000000],
    ...
    print(f"Estado final: Grid={metricas['itens_no_grid']}, Carregando={metricas['formigas_carregando']}")
