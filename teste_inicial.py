...
class AntClusteringHeterogêneo:
    ...
    def simular(self, num_iteracoes: int, verbose: bool = False, intervalo_log: int = 1000000,
                iteracoes_para_plotar: List[int] = None, pasta_saida: str = 'teste_graficos',
...
if __name__ == "__main__":
    ...
    tempo = clustering.simular(
        ...
        verbose=True,
        intervalo_log=50000,
        iteracoes_para_plotar=[0, 50000, 100000, 200000, 350000, 500000],
        pasta_saida=pasta_saida,
        intervalo_metricas=50000
    )
